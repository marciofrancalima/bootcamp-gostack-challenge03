# Desafio 03. Continuando aplicação (Bootcamp)

Desenvolvido no bootcamp gostack da Rocketseat. Requisitos abaixo:

Aprimorando a aplicação Meetapp do desafio 02.
```
...
Abaixo estão descritas as funcionalidades adicionadas à aplicação:
